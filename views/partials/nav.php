        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/test" class="<?= urlIs("/test/") ? 'bg-gray-900 text-red' : 'text-gray-300';?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white" aria-current="page">Home</a>
              <a href="/test/about/" class="<?= urlIs("/test/about/") ? 'bg-gray-900 text-red' : 'text-gray-300';?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">About Us</a>
              <a href="/test/contact/" class="<?= urlIs("/test/contact/") ? 'bg-gray-900 text-red' : 'text-gray-300';?>rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Contact Us</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
